...
const Header = () => {
  ...
  const { city, updateCity, detectLocation } = useLocation();
  const [mobileMenuOpen, setMobileMenuOpen] = useState(false);

  const topCities = ["New Delhi", "Mumbai", "Bangalore", "Hyderabad", "Pune", "Chennai", "Kolkata"];
          ...
          <div className="hidden lg:block">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center gap-1 text-gray-700 hover:bg-gray-50 px-2">
              ...
              <DropdownMenuContent align="start" className="w-56">
                ...
                <div className="max-h-60 overflow-y-auto">
                  <div className="px-2 py-1.5 text-xs font-semibold text-gray-500">Top Cities</div>
